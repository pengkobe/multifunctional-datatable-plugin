...
(function (window, document, undefined) {
    (function (factory) {
        "use strict";
        if (jQuery && !jQuery.fn.dataTableUX) {
            // 避免加载多次
            factory(jQuery);
            return;
        }
    ...
    var DataTableUX = function (element, options) {
        ...
        var default_options = {
            ...
            oLanguage: {
                ...
                sProcessing: '<img src="img/loading.gif" style="width: 20px; height: 20px;vertical-align:top">',
        ...
        function fixServerData(sSource, aoData, fnCallback, t) {
            ...
            $.ajax({
                type: "POST",
                url:  global_opt.ajax.url ? global_opt.ajax.url : global_opt.ajax,
                dataType: "json",
                data: ajaxParams,
